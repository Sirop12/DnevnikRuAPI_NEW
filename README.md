...
СКОРО автоматическая регистрация через госуслуги


## Обзор
Модуль `DnevnikFormatter` — это Python-класс для работы с API Дневник.ру без госуслуг. Он упрощает получение и анализ данных об уроках, оценках и успеваемости школьников. Класс предназначен для родителей, учителей или администраторов, которые хотят быстро получить расписание, оценки, рейтинги учеников или статистику класса.
